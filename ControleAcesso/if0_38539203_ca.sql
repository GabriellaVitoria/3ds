...
-- Tempo de geração: 07/04/2025 às 10:49
...
--
-- Banco de dados: `if0_38539203_ca`
--
...
INSERT INTO `morador` (`id_morador`, `nome`, `cpf`, `apartamento`, `bloco`, `telefone`) VALUES
(1, 'Talia Santana', 987654321, 12, 1, '4321-5678'),
(2, 'Aurelio Duarte', 123456789, 37, 1, '8765-5432'),
(3, 'Márcia Santos', 999888777, 110, 2, '2233-4455'),
(4, 'Lucia Almeida', 333444555, 71, 1, '7869-3415'),
(5, 'Carlos Andrade', 244477766, 98, 2, '5151-2323'),
(6, 'Lilian Farias', 888222111, 26, 2, '6543-5698');
